...
import UI.Strategy.ButtonPlayPaint;
...
public class ButtonPlay extends JButton {
	...
	private ButtonPlayPaint btnPlayPaint;
	...
	public ButtonPlay(PanelPlayer p) {
		...
		btnPlayPaint = new ButtonPlayPaint(this);
	}

	@Override
	public void paint(Graphics g) {

		btnPlayPaint.paintStrategy(g);
...
//		}
	...
	public PanelPlayer getP() {
		return p;
	}

	public void setP(PanelPlayer p) {
		this.p = p;
	}
}
